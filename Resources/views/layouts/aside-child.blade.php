                                ...
                                <div class="m-0">
                                    ...
                                    <div class="d-flex mb-10">
                                        ...
                                        <div class="flex-shrink-0 ms-2">
                                            ...
                                            <!--begin::Menu-->
                                            <!--begin::Menu 1-->
                                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_637df7ac4c481">
                                                <!--begin::Header-->
                                                <div class="px-7 py-5">
                                                ...
                                                <div class="px-7 py-5">
                                                    ...
                                                    <div class="mb-10">
                                                        ...
                                                        <!--begin::Input-->
                                                        <div>
                                                            <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_637df7ac4c481" data-allow-clear="true">
                                                                <option></option>
                                    ...
                                    <div id="kt_aside_menu_wrapper" class="menu-fit">
                                        ...
                                        <div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                            ...
                                            <div class="menu-sub menu-sub-accordion">
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link active" href="../../demo7/dist/dashboards/projects.html">
                                                        <span class="menu-bullet">
                                                            <span class="bullet bullet-dot"></span>
                                                        </span>
