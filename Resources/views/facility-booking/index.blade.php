...
@section('content')
    <style>
        ...
        <div class="d-flex justify-content-end align-items-center position-relative my-1 mb-4">
            <div class="d-flex align-items-center">
                <input type="text" data-kt-customer-table-filter="search" class="form-control w-250px form-control-solid ps-15" id="search_facility" name="search_facility" placeholder="Search Facility"/>
