<div class="modal fade" id="kt_modal_create_project" tabindex="-1" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            <!--begin::Form-->
            <form class="form" action="#" id="kt_modal_create_project_form">
                <!--begin::Modal header-->
                <div class="modal-header" id="kt_modal_create_project_header">
                    <!--begin::Modal title-->
                ...
                <div class="modal-body py-10 px-lg-17">
                    <!--begin::Scroll-->
                    <div class="scroll-y me-n7 pe-7" id="kt_modal_create_project_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_create_project_header" data-kt-scroll-wrappers="#kt_modal_create_project_scroll" data-kt-scroll-offset="300px">
                        <!--begin::Notice-->
                        <!--begin::Notice-->
                        <div class="notice d-flex bg-light-success rounded border-success border border-dashed mb-9 p-6">
                            ...
                            <div class="d-flex flex-stack flex-grow-1">
                                ...
                                <div class="fw-semibold">
                                    <h4 class="text-gray-900 fw-bold">Info</h4>
                                    <div class="fs-6 text-gray-700">Booking available only for hall and court
                        ...
                        <div class="d-flex flex-column mb-5 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Select-->
                            <select name="country" data-control="select2" data-dropdown-parent="#kt_modal_create_project" data-placeholder="Select a Country..." class="form-select form-select-solid">
                ...
                <div class="modal-footer flex-center">
                    <!--begin::Button-->
                    <button type="reset" id="kt_modal_create_project_cancel" class="btn btn-light me-3">Discard</button>
                    <!--end::Button-->
                    <!--begin::Button-->
                    <button type="submit" id="kt_modal_create_project_submit" class="btn btn-primary">
