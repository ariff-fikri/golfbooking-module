...
<head>
    ...
    <meta property="og:site_name" content="Cara Golf" />
    ...
    {{-- <link href="{{ Module::asset('golfbooking:css/assets/style.bundle.css') }}" rel="stylesheet" type="text/css" /> --}}
...
<body id="kt_body" style="background-image: url()" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-enabled">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            @include('golfbooking::layouts.aside-parent')
            <!--begin::Wrapper-->
                ...
                <div id="kt_header" class="header" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{default: '200px', lg: '300px'}">
                    ...
                    <div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
                        ...
                        <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap mt-n5 mt-lg-0 me-lg-2 pb-2 pb-lg-0"
                            ...
                            <!--begin::Heading-->
                            <h1 class="text-dark fw-bold my-0 fs-2">Hello Admin,</h1>
                            <!--end::Heading-->
                             <span class="fw-semibold fs-base my-1"> 17th February 2023</span>
                            ...
                            <div class="d-flex align-items-center ms-1" id="kt_header_user_menu_toggle">
                                ...
                                <div class="btn btn-flex align-items-center bg-hover-white bg-hover-opacity-10 py-2 px-2 px-md-3" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                    ...
                                    <div class="d-none d-md-flex flex-column align-items-end justify-content-center me-2 me-md-4">
                                        ...
                                        <span class="text-gray fs-8 fw-bold lh-1">UX Designer</span>
                                    </div>
                                    <!--end::Name-->
