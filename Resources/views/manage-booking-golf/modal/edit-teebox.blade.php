...
<div class="modal fade" id="kt_modal_edit_teebox" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                <!--begin::Form-->
                <form action="{{ route('facility-booking.manage-booking.update', $teebox->id) }}" method="POST" enctype="multipart/form-data" novalidate="novalidate" id="form-edit-teebox">
                    @csrf
                    <!--begin::Input group-->
                    <div class="d-flex flex-column mb-7 fv-row">
                        ...
                        <!--end::Label-->
                        <input type="text" class="form-control" placeholder="" name="name" value="{{ $teebox->name }}" />
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-8 fv-row">
                            ...
                            <!--end::Label-->
                            <input class="form-control" placeholder="Pick a date" id="expiration_date_edit" name="expiration_date" value="{{ $teebox->expiration_date }}"/>
                        </div>
                        <!--end::Col-->
                        <!--begin::Col-->
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="position-relative">
                                <!--begin::Input-->
                                <input type="text" class="form-control" minlength="3" maxlength="4" placeholder="Slot" name="slot" value="{{ $teebox->slot }}"/>
                                <!--end::Input-->
                                <!--begin::CVV icon-->
                    ...
                    <!--end::Input group-->
                     ...
                     <div class="d-flex flex-column mb-7 fv-row">
                        ...
                        <!--end::Label-->
                        <input class="form-control" placeholder="Pick a date" id="disable_dates_edit" name="disable_date" value="{{ $teebox->disable_date }}"/>
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="text-center pt-15">
                        ...
                        <button type="submit" id="edit-teebox-submit" class="btn btn-primary">
...
<!--end::Modal - New Card-->
<script src="{{ Module::asset('golfbooking:js/custom/manage-booking-golf/edit-teebox.js') }}"></script>
