...
<html lang="en">
	...
	<head><base href=""/>
		...
		<link rel="shortcut icon" href="{{ Module::asset('golfbooking:media/logos/favicon.ico') }}" />
		<!--begin::Fonts(mandatory for all pages)-->
		<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Inter:300,400,500,600,700" />
		<!--end::Fonts-->
		<!--begin::Vendor Stylesheets(used for this page only)-->
		<link href="{{ Module::asset('golfbooking:plugins/custom/fullcalendar/fullcalendar.bundle.css') }}" rel="stylesheet" type="text/css" />
		<link href="{{ Module::asset('golfbooking:plugins/custom/datatables/datatables.bundle.css') }}" rel="stylesheet" type="text/css" />
					...
					<div class="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
						...
						<div class="aside-logo d-none d-lg-flex flex-column align-items-center flex-column-auto py-10" id="kt_aside_logo">
							<a href="../../demo7/dist/index.html">
								<img alt="Logo" src="{{ Module::asset('golfbooking:media/logos/demo7.svg') }}" class="h-35px" />
							</a>
						</div>
						<!--end::Logo-->
						<!--begin::Nav-->
						...
						<div class="aside-footer d-flex flex-column align-items-center flex-column-auto" id="kt_aside_footer">
							...
							<div class="d-flex align-items-center mb-2">
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
									<!--begin::Heading-->
									<div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style="background-image:url'({{ Module::asset('golfbooking:media/misc/dropdown-header-bg.png') }})'">
										<!--begin::Title-->
							...
							<div class="d-flex align-items-center mb-2">
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
									<!--begin::Heading-->
									<div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{ Module::asset('golfbooking:media/misc/dropdown-header-bg.png') }}')">
										<!--begin::Title-->
										...
										<div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
											...
											<div class="d-flex flex-column px-9">
												...
												<div class="text-center px-4">
													<img class="mw-100 mh-200px" alt="image" src="{{ Module::asset('golfbooking:media/illustrations/sigma-1/1.png') }}" />
												</div>
												<!--end::Illustration-->
											</div>
											<!--end::Wrapper-->
							...
							<div class="d-flex align-items-center mb-10" id="kt_header_user_menu_toggle">
								...
								<div class="cursor-pointer symbol symbol-40px" data-kt-menu-trigger="click" data-kt-menu-overflow="true" data-kt-menu-placement="top-start" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-dismiss="click" title="User profile">
									<img src="{{ Module::asset('golfbooking:media/avatars/300-1.jpg') }}" alt="image" />
								</div>
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
									...
									<div class="menu-item px-3">
										<div class="menu-content d-flex align-items-center px-3">
											...
											<div class="symbol symbol-50px me-5">
												<img alt="Logo" src="{{ Module::asset('golfbooking:media/avatars/300-1.jpg') }}" />
											</div>
											<!--end::Avatar-->
											<!--begin::Username-->
									...
									<div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="right-end" data-kt-menu-offset="-15px, 0">
										<a href="#" class="menu-link px-5">
											...
											<img class="w-15px h-15px rounded-1 ms-2" src="{{ Module::asset('golfbooking:media/flags/united-states.svg') }}" alt="" /></span></span>
										</a>
										<!--begin::Menu sub-->
										<div class="menu-sub menu-sub-dropdown w-175px py-4">
											<!--begin::Menu item-->
											<div class="menu-item px-3">
												...
												<span class="symbol symbol-20px me-4">
													<img class="rounded-1" src="{{ Module::asset('golfbooking:media/flags/united-states.svg') }}" alt="" />
												</span>English</a>
											</div>
											<!--end::Menu item-->
											<!--begin::Menu item-->
											<div class="menu-item px-3">
												...
												<span class="symbol symbol-20px me-4">
													<img class="rounded-1" src="{{ Module::asset('golfbooking:media/flags/spain.svg') }}" alt="" />
												</span>Spanish</a>
											</div>
											<!--end::Menu item-->
											<!--begin::Menu item-->
											<div class="menu-item px-3">
												<a href="../../demo7/dist/account/settings.html" class="menu-link d-flex px-5">
												<span class="symbol symbol-20px me-4">
													<img class="rounded-1" src="{{ Module::asset('golfbooking:media/flags/germany.svg') }}" alt="" />
												</span>German</a>
											</div>
											<!--end::Menu item-->
											<!--begin::Menu item-->
											<div class="menu-item px-3">
												<a href="../../demo7/dist/account/settings.html" class="menu-link d-flex px-5">
												<span class="symbol symbol-20px me-4">
													<img class="rounded-1" src="{{ Module::asset('golfbooking:media/flags/japan.svg') }}" alt="" />
												</span>Japanese</a>
											</div>
											<!--end::Menu item-->
											<!--begin::Menu item-->
											<div class="menu-item px-3">
												<a href="../../demo7/dist/account/settings.html" class="menu-link d-flex px-5">
												<span class="symbol symbol-20px me-4">
													<img class="rounded-1" src="{{ Module::asset('golfbooking:media/flags/france.svg') }}" alt="" />
												</span>French</a>
											</div>
											<!--end::Menu item-->
										</div>
									...
									<div class="tab-content">
											...
											<div class="m-0">
												...
												<div class="d-flex mb-10">
																	...
																	<div class="scroll-y mh-200px mh-lg-350px">
																		...
																		<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																			...
																			<div class="symbol symbol-40px me-4">
																				<img src="{{ Module::asset('golfbooking:media/avatars/300-6.jpg') }}" alt="" />
																			</div>
																			<!--end::Symbol-->
																			<!--begin::Title-->
																		...
																		<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																			<!--begin::Symbol-->
																			<div class="symbol symbol-40px me-4">
																				<img src="{{ Module::asset('golfbooking:media/avatars/300-2.jpg') }}" alt="" />
																			</div>
																			<!--end::Symbol-->
																			<!--begin::Title-->
																			<div class="d-flex flex-column justify-content-start fw-semibold">
																		...
																		<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																			<!--begin::Symbol-->
																			<div class="symbol symbol-40px me-4">
																				<img src="{{ Module::asset('golfbooking:media/avatars/300-9.jpg') }}" alt="" />
																			</div>
																			<!--end::Symbol-->
																			<!--begin::Title-->
																			<div class="d-flex flex-column justify-content-start fw-semibold">
																		...
																		<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																			<!--begin::Symbol-->
																			<div class="symbol symbol-40px me-4">
																				<img src="{{ Module::asset('golfbooking:media/avatars/300-14.jpg') }}" alt="" />
																			</div>
																			<!--end::Symbol-->
																			<!--begin::Title-->
																			<div class="d-flex flex-column justify-content-start fw-semibold">
																		...
																		<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																			<!--begin::Symbol-->
																			<div class="symbol symbol-40px me-4">
																				<img src="{{ Module::asset('golfbooking:media/avatars/300-11.jpg') }}" alt="" />
																			</div>
																			<!--end::Symbol-->
																			<!--begin::Title-->
																			<div class="d-flex flex-column justify-content-start fw-semibold">
																		...
																		<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																			...
																			<div class="symbol symbol-40px me-4">
																				<span class="symbol-label bg-light">
																					<img class="w-20px h-20px" src="{{ Module::asset('golfbooking:media/svg/brand-logos/volicity-9.svg') }}" alt="" />
																				</span>
																			</div>
																			<!--end::Symbol-->
																			<!--begin::Title-->
																		...
																		<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																			...
																			<div class="symbol symbol-40px me-4">
																				<span class="symbol-label bg-light">
																					<img class="w-20px h-20px" src="{{ Module::asset('golfbooking:media/svg/brand-logos/tvit.svg') }}" alt="" />
																				</span>
																			</div>
																			<!--end::Symbol-->
																			<!--begin::Title-->
																		...
																		<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																			...
																			<div class="symbol symbol-40px me-4">
																				<span class="symbol-label bg-light">
																					<img class="w-20px h-20px" src="{{ Module::asset('golfbooking:media/svg/misc/infography.svg') }}" alt="" />
																				</span>
																			</div>
																			<!--end::Symbol-->
																			<!--begin::Title-->
																		...
																		<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																			...
																			<div class="symbol symbol-40px me-4">
																				<span class="symbol-label bg-light">
																					<img class="w-20px h-20px" src="{{ Module::asset('golfbooking:media/svg/brand-logos/leaf.svg') }}" alt="" />
																				</span>
																			</div>
																			<!--end::Symbol-->
																			<!--begin::Title-->
																		...
																		<a href="#" class="d-flex text-dark text-hover-primary align-items-center mb-5">
																			...
																			<div class="symbol symbol-40px me-4">
																				<span class="symbol-label bg-light">
																					<img class="w-20px h-20px" src="{{ Module::asset('golfbooking:media/svg/brand-logos/tower.svg') }}" alt="" />
																				</span>
																			</div>
																			<!--end::Symbol-->
																			<!--begin::Title-->
													...
													<div class="flex-shrink-0 ms-2">
														...
														<!--begin::Menu-->
														<!--begin::Menu 1-->
														<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_63de810b7e545">
															<!--begin::Header-->
															<div class="px-7 py-5">
															...
															<div class="px-7 py-5">
																...
																<div class="mb-10">
																	...
																	<!--begin::Input-->
																	<div>
																		<select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_63de810b7e545" data-allow-clear="true">
																			<option></option>
												...
												<div class="m-0">
													...
													<div class="mb-10">
														...
														<a href="../../demo7/dist/apps/projects/project.html" class="custom-list d-flex align-items-center px-5 py-4">
															...
															<div class="symbol symbol-40px me-5">
																<span class="symbol-label">
																	<img src="{{ Module::asset('golfbooking:media/svg/brand-logos/bebo.svg') }}" class="h-50 align-self-center" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Description-->
														...
														<a href="../../demo7/dist/apps/projects/project.html" class="custom-list d-flex align-items-center px-5 py-4">
															...
															<div class="symbol symbol-40px me-5">
																<span class="symbol-label">
																	<img src="{{ Module::asset('golfbooking:media/svg/brand-logos/vimeo.svg') }}" class="h-50 align-self-center" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Description-->
														...
														<a href="../../demo7/dist/apps/projects/project.html" class="custom-list d-flex align-items-center px-5 py-4">
															...
															<div class="symbol symbol-40px me-5">
																<span class="symbol-label">
																	<img src="{{ Module::asset('golfbooking:media/svg/brand-logos/kickstarter.svg') }}" class="h-50 align-self-center" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Description-->
														...
														<a href="../../demo7/dist/apps/projects/project.html" class="custom-list d-flex align-items-center px-5 py-4">
															...
															<div class="symbol symbol-40px me-5">
																<span class="symbol-label">
																	<img src="{{ Module::asset('golfbooking:media/svg/brand-logos/balloon.svg') }}" class="h-50 align-self-center" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Description-->
														...
														<a href="../../demo7/dist/apps/projects/project.html" class="custom-list d-flex align-items-center px-5 py-4">
															...
															<div class="symbol symbol-40px me-5">
																<span class="symbol-label">
																	<img src="{{ Module::asset('golfbooking:media/svg/brand-logos/infography.svg') }}" class="h-50 align-self-center" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Description-->
														...
														<a href="../../demo7/dist/apps/projects/project.html" class="custom-list d-flex align-items-center px-5 py-4">
															...
															<div class="symbol symbol-40px me-5">
																<span class="symbol-label">
																	<img src="{{ Module::asset('golfbooking:media/svg/brand-logos/disqus.svg') }}" class="h-50 align-self-center" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Description-->
														...
														<a href="../../demo7/dist/apps/projects/project.html" class="custom-list d-flex align-items-center px-5 py-4">
															...
															<div class="symbol symbol-40px me-5">
																<span class="symbol-label">
																	<img src="{{ Module::asset('golfbooking:media/svg/brand-logos/plurk.svg') }}" class="h-50 align-self-center" alt="" />
																</span>
															</div>
															<!--end::Symbol-->
															<!--begin::Description-->
										...
										<div class="tab-pane fade" id="kt_aside_nav_tab_subscription" role="tabpanel">
											...
											<div class="mx-5">
												...
												<!--begin::Illustration-->
												<div class="text-center px-4">
													<img src="{{ Module::asset('golfbooking:media/illustrations/sigma-1/18.png') }}" alt="" class="mw-100 mh-300px" />
												</div>
												<!--end::Illustration-->
											</div>
											<!--end::Subscription-->
											...
											<div class="mx-5">
												...
												<div class="mb-12">
													...
													<div class="d-flex align-items-center mb-7">
														<!--begin::Avatar-->
														<div class="symbol symbol-50px me-5">
															<img src="{{ Module::asset('golfbooking:media/avatars/300-6.jpg') }}" class="" alt="" />
														</div>
														<!--end::Avatar-->
														<!--begin::Text-->
													...
													<div class="d-flex align-items-center mb-7">
														<!--begin::Avatar-->
														<div class="symbol symbol-50px me-5">
															<img src="{{ Module::asset('golfbooking:media/avatars/300-5.jpg') }}" class="" alt="" />
														</div>
														<!--end::Avatar-->
														<!--begin::Text-->
														<div class="flex-grow-1">
													...
													<div class="d-flex align-items-center mb-7">
														<!--begin::Avatar-->
														<div class="symbol symbol-50px me-5">
															<img src="{{ Module::asset('golfbooking:media/avatars/300-11.jpg') }}" class="" alt="" />
														</div>
														<!--end::Avatar-->
														<!--begin::Text-->
														<div class="flex-grow-1">
													...
													<div class="d-flex align-items-center mb-7">
														<!--begin::Avatar-->
														<div class="symbol symbol-50px me-5">
															<img src="{{ Module::asset('golfbooking:media/avatars/300-23.jpg') }}" class="" alt="" />
														</div>
														<!--end::Avatar-->
														<!--begin::Text-->
														<div class="flex-grow-1">
													...
													<div class="d-flex align-items-center mb-7">
														<!--begin::Avatar-->
														<div class="symbol symbol-50px me-5">
															<img src="{{ Module::asset('golfbooking:media/avatars/300-10.jpg') }}" class="" alt="" />
														</div>
														<!--end::Avatar-->
														<!--begin::Text-->
														<div class="flex-grow-1">
													...
													<div class="d-flex align-items-center mb-7">
														<!--begin::Avatar-->
														<div class="symbol symbol-50px me-5">
															<img src="{{ Module::asset('golfbooking:media/avatars/300-9.jpg') }}" class="" alt="" />
														</div>
														<!--end::Avatar-->
														<!--begin::Text-->
														<div class="flex-grow-1">
													...
													<div class="d-flex align-items-center">
														<!--begin::Avatar-->
														<div class="symbol symbol-50px me-5">
															<img src="{{ Module::asset('golfbooking:media/avatars/300-12.jpg') }}" class="" alt="" />
														</div>
														<!--end::Avatar-->
														<!--begin::Text-->
														<div class="flex-grow-1">
						...
						<div class="container-xxl d-flex align-items-center justify-content-between" id="kt_header_container">
							...
							<div class="d-flex d-lg-none align-items-center ms-n2 me-2">
								...
								<a href="../../demo7/dist/index.html" class="d-flex align-items-center">
									<img alt="Logo" src="{{ Module::asset('golfbooking:media/logos/demo7.svg') }}" class="h-30px" />
								</a>
								<!--end::Logo-->
							</div>
							<!--end::Wrapper-->
													...
													<tbody>
														...
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	<div class="symbol symbol-45px me-5">
																		<img src="{{ Module::asset('golfbooking:media/avatars/300-5.jpg') }}" alt="" />
																	</div>
																	<div class="d-flex justify-content-start flex-column">
														...
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	<div class="symbol symbol-45px me-5">
																		<img src="{{ Module::asset('golfbooking:media/avatars/300-20.jpg') }}" alt="" />
																	</div>
																	<div class="d-flex justify-content-start flex-column">
														...
														<tr>
															...
															<td>
																<div class="d-flex align-items-center">
																	<div class="symbol symbol-45px me-5">
																		<img src="{{ Module::asset('golfbooking:media/avatars/300-23.jpg') }}" alt="" />
																	</div>
																	<div class="d-flex justify-content-start flex-column">
										...
										<div class="card-body pt-5">
											...
											<div class="d-flex mb-7">
												...
												<div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
													<img src="{{ Module::asset('golfbooking:media/stock/600x400/img-3.jpg') }}" class="mw-100" alt="" />
												</div>
												<!--end::Symbol-->
												<!--begin::Section-->
											...
											<div class="d-flex mb-7">
												<!--begin::Symbol-->
												<div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
													<img src="{{ Module::asset('golfbooking:media/stock/600x400/img-4.jpg') }}" class="mw-100" alt="" />
												</div>
												<!--end::Symbol-->
												<!--begin::Section-->
												<div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
											...
											<div class="d-flex mb-7">
												<!--begin::Symbol-->
												<div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
													<img src="{{ Module::asset('golfbooking:media/stock/600x400/img-5.jpg') }}" class="mw-100" alt="" />
												</div>
												<!--end::Symbol-->
												<!--begin::Section-->
												<div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
											...
											<div class="d-flex mb-7">
												<!--begin::Symbol-->
												<div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
													<img src="{{ Module::asset('golfbooking:media/stock/600x400/img-6.jpg') }}" class="mw-100" alt="" />
												</div>
												<!--end::Symbol-->
												<!--begin::Section-->
												<div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
											...
											<div class="d-flex">
												<!--begin::Symbol-->
												<div class="symbol symbol-60px symbol-2by3 flex-shrink-0 me-4">
													<img src="{{ Module::asset('golfbooking:media/stock/600x400/img-7.jpg') }}" class="mw-100" alt="" />
												</div>
												<!--end::Symbol-->
												<!--begin::Section-->
												<div class="d-flex align-items-center flex-wrap flex-grow-1 mt-n2 mt-lg-n1">
									...
									<div class="card card-xxl-stretch mb-5 mb-xl-8">
										...
										<div class="card-body pt-5">
											...
											<div class="d-flex align-items-sm-center mb-7">
												...
												<div class="symbol symbol-50px me-5">
													<span class="symbol-label">
														<img src="{{ Module::asset('golfbooking:media/svg/brand-logos/telegram.svg') }}" class="h-50 align-self-center" alt="" />
													</span>
												</div>
												<!--end::Symbol-->
												<!--begin::Section-->
											...
											<div class="d-flex align-items-sm-center">
												...
												<div class="symbol symbol-50px me-5">
													<span class="symbol-label">
														<img src="{{ Module::asset('golfbooking:media/svg/brand-logos/fox-hub.svg') }}" class="h-50 align-self-center" alt="" />
													</span>
												</div>
												<!--end::Symbol-->
												<!--begin::Section-->
											...
											<div class="mt-5">
													...
													<div class="d-flex align-items-center me-2">
														...
														<div class="symbol symbol-50px me-3">
															<div class="symbol-label bg-light">
																<img src="{{ Module::asset('golfbooking:media/svg/brand-logos/plurk.svg') }}" class="h-50" alt="" />
															</div>
														</div>
														<!--end::Symbol-->
														<!--begin::Title-->
												...
												<div class="d-flex flex-stack mb-5">
													...
													<div class="d-flex align-items-center me-2">
														...
														<div class="symbol symbol-50px me-3">
															<div class="symbol-label bg-light">
																<img src="{{ Module::asset('golfbooking:media/svg/brand-logos/figma-1.svg') }}" class="h-50" alt="" />
															</div>
														</div>
														<!--end::Symbol-->
														<!--begin::Title-->
												...
												<div class="d-flex flex-stack">
													...
													<div class="d-flex align-items-center me-2">
														...
														<div class="symbol symbol-50px me-3">
															<div class="symbol-label bg-light">
																<img src="{{ Module::asset('golfbooking:media/svg/brand-logos/vimeo.svg') }}" class="h-50" alt="" />
															</div>
														</div>
														<!--end::Symbol-->
														<!--begin::Title-->
									...
									<div class="pe-3 mb-5">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Nina Nilson">
												<img src="{{ Module::asset('golfbooking:media/avatars/300-14.jpg') }}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="overflow-auto pb-5">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
											...
											<div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px pe-2">
												...
												<div class="symbol symbol-circle symbol-25px">
													<img src="{{ Module::asset('golfbooking:media/avatars/300-2.jpg') }}" alt="img" />
												</div>
												<!--end::User-->
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
											...
											<div class="symbol-group symbol-hover flex-nowrap flex-grow-1 min-w-100px">
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
													<img src="{{ Module::asset('golfbooking:media/avatars/300-20.jpg') }}" alt="img" />
												</div>
												<!--end::User-->
												<!--begin::User-->
												<div class="symbol symbol-circle symbol-25px">
									...
									<div class="overflow-auto pe-3">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Alan Nilson">
												<img src="{{ Module::asset('golfbooking:media/avatars/300-1.jpg') }}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="mb-5 pe-3">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Jan Hummer">
												<img src="{{ Module::asset('golfbooking:media/avatars/300-23.jpg') }}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
									...
									<div class="overflow-auto pb-5">
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="" class="w-30px me-3" src="{{ Module::asset('golfbooking:media/svg/files/pdf.svg') }}" />
												<!--end::Icon-->
												<!--begin::Info-->
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="../../demo7/dist/apps/projects/project.html" class="w-30px me-3" src="{{ Module::asset('golfbooking:media/svg/files/doc.svg') }}" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
											...
											<div class="d-flex flex-aligns-center">
												<!--begin::Icon-->
												<img alt="../../demo7/dist/apps/projects/project.html" class="w-30px me-3" src="{{ Module::asset('golfbooking:media/svg/files/css.svg') }}" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-7">
											...
											<div class="overlay me-10">
												...
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-150px" src="{{ Module::asset('golfbooking:media/stock/600x400/img-29.jpg') }}" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
											...
											<div class="overlay me-10">
												<!--begin::Image-->
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-150px" src="{{ Module::asset('golfbooking:media/stock/600x400/img-31.jpg') }}" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
												<div class="overlay-layer bg-dark bg-opacity-10 rounded">
											...
											<div class="overlay">
												<!--begin::Image-->
												<div class="overlay-wrapper">
													<img alt="img" class="rounded w-150px" src="{{ Module::asset('golfbooking:media/stock/600x400/img-40.jpg') }}" />
												</div>
												<!--end::Image-->
												<!--begin::Link-->
												<div class="overlay-layer bg-dark bg-opacity-10 rounded">
									...
									<div class="pe-3 mb-5">
										...
										<div class="d-flex align-items-center mt-1 fs-6">
											...
											<div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="Robert Rich">
												<img src="{{ Module::asset('golfbooking:media/avatars/300-4.jpg') }}" alt="img" />
											</div>
											<!--end::User-->
										</div>
										<!--end::Description-->
							...
							<div class="d-flex flex-column align-items-start">
								...
								<div class="d-flex align-items-center mb-2">
									...
									<div class="symbol symbol-35px symbol-circle">
										<img alt="Pic" src="{{ Module::asset('golfbooking:media/avatars/300-25.jpg') }}" />
									</div>
									<!--end::Avatar-->
									<!--begin::Details-->
									<div class="ms-3">
						...
						<div class="d-flex justify-content-end mb-10">
							...
							<div class="d-flex flex-column align-items-end">
								...
								<div class="d-flex align-items-center mb-2">
									...
									<!--begin::Avatar-->
									<div class="symbol symbol-35px symbol-circle">
										<img alt="Pic" src="{{ Module::asset('golfbooking:media/avatars/300-1.jpg') }}" />
									</div>
									<!--end::Avatar-->
								</div>
								<!--end::User-->
				...
				<div class="card-body hover-scroll-overlay-y h-400px pt-5">
					...
					<div class="d-flex flex-stack">
						...
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="{{ Module::asset('golfbooking:media/stock/600x400/img-1.jpg') }}" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="{{ Module::asset('golfbooking:media/stock/600x400/img-3.jpg') }}" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="{{ Module::asset('golfbooking:media/stock/600x400/img-8.jpg') }}" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="{{ Module::asset('golfbooking:media/stock/600x400/img-26.jpg') }}" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="{{ Module::asset('golfbooking:media/stock/600x400/img-21.jpg') }}" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="{{ Module::asset('golfbooking:media/stock/600x400/img-34.jpg') }}" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<!--begin::Pic-->
						<div class="symbol symbol-70px symbol-2by3 flex-shrink-0">
							<img src="{{ Module::asset('golfbooking:media/stock/600x400/img-27.jpg') }}" alt="" />
						</div>
						<!--end::Pic-->
					</div>
					<!--end::Item-->
			...
			<div class="modal-dialog mw-650px">
				...
				<div class="modal-content">
					...
					<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
						...
						<img alt="Logo" src="{{ Module::asset('golfbooking:media/svg/brand-logos/google-icon.svg') }}" class="h-20px me-3" />Invite Gmail Contacts</div>
							...
							<div class="mh-300px scroll-y me-n7 pe-7">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="{{ Module::asset('golfbooking:media/avatars/300-6.jpg') }}" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="{{ Module::asset('golfbooking:media/avatars/300-5.jpg') }}" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="{{ Module::asset('golfbooking:media/avatars/300-9.jpg') }}" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="{{ Module::asset('golfbooking:media/avatars/300-23.jpg') }}" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="{{ Module::asset('golfbooking:media/avatars/300-12.jpg') }}" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="{{ Module::asset('golfbooking:media/avatars/300-13.jpg') }}" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										<!--begin::Avatar-->
										<div class="symbol symbol-35px symbol-circle">
											<img alt="Pic" src="{{ Module::asset('golfbooking:media/avatars/300-21.jpg') }}" />
										</div>
										<!--end::Avatar-->
										<!--begin::Details-->
										<div class="ms-5">
											...
											<div class="d-flex flex-column mb-7 fv-row">
												...
												<div class="position-relative">
													...
													<div class="position-absolute translate-middle-y top-50 end-0 me-5">
														<img src="{{ Module::asset('golfbooking:media/svg/card-logos/visa.svg') }}" alt="" class="h-25px" />
														<img src="{{ Module::asset('golfbooking:media/svg/card-logos/mastercard.svg') }}" alt="" class="h-25px" />
														<img src="{{ Module::asset('golfbooking:media/svg/card-logos/american-express.svg') }}" alt="" class="h-25px" />
													</div>
													<!--end::Card logos-->
												</div>
												<!--end::Input wrapper-->
									...
									<div data-kt-stepper-element="content">
										<div class="w-100 text-center">
											...
											<div class="text-center px-4 py-15">
												<img src="{{ Module::asset('golfbooking:media/illustrations/sigma-1/9.png') }}" alt="" class="mw-100 mh-300px" />
											</div>
											<!--end::Illustration-->
										</div>
									</div>
							...
							<div class="py-5">
								...
								<div data-kt-search-element="empty" class="text-center d-none">
									...
									<div class="text-center px-5">
										<img src="{{ Module::asset('golfbooking:media/illustrations/sigma-1/1.png') }}" alt="" class="w-100 h-200px h-sm-325px" />
									</div>
									<!--end::Illustration-->
								</div>
								<!--end::Empty-->
